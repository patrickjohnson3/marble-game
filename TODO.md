...
4. Finish stabilizing `real-world-maps` before merging.
5. Strengthen camera pinch tests for zoom direction, scale limits, and behavior before and after map release.
